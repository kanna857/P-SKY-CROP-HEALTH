...
export const DOCTOR_PROFILES: VoiceDoctorProfile[] = [
  {
    ...
    greetingText: {
      ...
      kn: 'ನಮಸ್ಕಾರ ರೈತ ಮಿತ್ರರೇ! ನಾನು ನಿಮ್ಮ AI ಬೆಳೆ ವೈದ್ಯ. ನಿಮ್ಮ ಹೊಲದಲ್ಲಿ ಯಾವ ರೋಗ ಅಥವಾ ಕೀಟ ಕಾಣಿಸುತ್ತಿದೆ?',
      bn: 'নমস্কার কৃষক বন্ধু! আমি আপনার AI শস্য চিকিৎসক। আপনার জমিতে কোন রোগ বা পোকা দেখা যাচ্ছে?',
      es: '¡Hola agricultor! Soy tu agrónomo de IA. ¿Qué enfermedad o síntoma de plaga estás viendo en tu cultivo?'
    }
  },
  {
    id: 'doc-fertilizer',
    ...
    greetingText: {
      ...
      kn: 'ನಮಸ್ಕಾರ! ನಾನು ಡಾ. ಶರ್ಮಾ, ಮಣ್ಣು ಮತ್ತು ರಸಗೊಬ್ಬರ ತಜ್ಞ. ನಿಮ್ಮ ಬೆಳೆಯ ಹಂತ ಮತ್ತು ರಸಗೊಬ್ಬರದ ಅಗತ್ಯವನ್ನು ತಿಳಿಸಿ.',
      bn: 'নমস্কার! আমি ডঃ শর্মা, মৃত্তিকা ও সার বিশেষজ্ঞ। আপনার ফসলের অবস্থা এবং সারের প্রয়োজনীয়তা জানান।',
      es: '¡Hola! Soy el Dr. Sharma, especialista en suelos y nutrición. Cuéntame sobre la etapa de tu cultivo y tus necesidades de fertilizante.'
    }
  },
  {
    id: 'doc-market',
    ...
    greetingText: {
      ...
      kn: 'ಕಿಸಾನ್ ಮಂಡಿ ಡೆಸ್ಕ್! ಗೋಧಿ, ಭತ್ತ, ಟೊಮೇಟೊ ಅಥವಾ ಹತ್ತಿಯ ಇಂದಿನ ಮಾರುಕಟ್ಟೆ ದರಗಳನ್ನು ಕೇಳಿ.',
      bn: 'কিষাণ মান্ডি ডেস্ক! গম, ধান, টমেটো বা তুলোর আজকের পাইকারি বাজার দর জানতে চান?',
      es: '¡Mesa de Mercado Agrícola activa! Consulta los precios de mercado de hoy para trigo, arroz, tomate o algodón.'
    }
  }
];
